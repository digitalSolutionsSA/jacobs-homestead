...
const allPosts = [
  ...
  { id: 3, category: 'Simple Living', title: 'Preserving the Harvest: A Beginner\'s Canning Guide', excerpt: 'Step-by-step guidance on water bath canning so you can stock your pantry with summer\'s bounty all winter long.', date: 'February 10, 2025', image: 'https://images.unsplash.com/photo-1601598851547-4302969d0614?w=600&q=80' },
  ...
  { id: 6, category: 'Other', title: 'Starting a Kitchen Garden From Scratch', excerpt: 'Our step-by-step approach to building a productive kitchen garden, even if you\'ve never grown a single thing before.', date: 'December 18, 2024', image: 'https://images.unsplash.com/photo-1592419044706-39796d40f98c?w=600&q=80' },
  { id: 7, category: 'Other', title: 'Finding Sabbath Rest on a Working Homestead', excerpt: 'One of the hardest lessons we\'ve learned: the homestead does not demand our constant labor. Neither does God.', date: 'December 5, 2024', image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&q=80' },
...
const categories = ['All', 'Homeschooling', 'Chickens', 'Simple Living', 'Other']
